 ...
 * @group logging
 *
 * @coversDefaultClass \AvtoDev\EventsLogLaravel\Logging\DefaultUdpLogstashLogger
 */
class DefaultUdpLogstashLoggerTest extends AbstractTestCase
{
    ...
    public function testInstanceCreator(): void
    {
        ...
        /** @var Logger $instance */
        $instance = (new DefaultUdpLogstashLogger)($config);
        ...
        $this->assertInstanceOf(DefaultLogstashFormatter::class, $formatter);
